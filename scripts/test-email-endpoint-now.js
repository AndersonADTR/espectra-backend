// scripts/test-email-endpoint-now.js
...
// Función para probar el endpoint de test-email
async function testEmailEndpoint() {
  try {
    console.log('Probando endpoint de test-email...');
    ...
    if (response.status === 200 && response.data.success) {
      ...
      console.log('Por favor, verifica tu bandeja de entrada (y la carpeta de spam) para ver si has recibido el correo de prueba.');
    } else {
